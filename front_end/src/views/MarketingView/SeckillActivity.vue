      ...
      <el-main>
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="上线/下线" align="center" width="150">
            <template #default="scope">
              <el-switch
                v-model="scope.row.upper_line"
                class="ml-2"
                @change="meg(scope.row)"
                style="
          ...
          <el-table-column label="操作" align="center" width="360">
            <template #default="scope">
              <el-button size="small" plain @click="setup(scope.row)"
                >设置商品</el-button
              >
              <el-button
                size="small"
        ...
        <el-dialog v-model="dialog" title="提示" width="30%" align="left">
          <div class="wei">
            ...
            />
            <span style="margin-left: 5%; font-size: 18px"
              >是否要删除该条数据</span
            >
          </div>
          <template #footer>
