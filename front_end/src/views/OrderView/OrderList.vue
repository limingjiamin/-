...
<!--  删除信息的对话框提示-->
  ...
  >
    <el-steps  :active="4" finish-status="success" direction="vertical" >
      ...
      <el-step title="在北京市进行下级地点扫描，等待付款" description="2022-04-01 12:00:00"/>
      <el-step title="在分拨中心广东深圳公司进行卸车扫描" description="2022-04-01 12:00:00"/>
      <el-step title="在广东深圳公司进行发出扫描" description="2022-04-01 12:00:00"/>
      <el-step title="到达目的地网点广东深圳公司，快件很快进行派送" description="2022-04-01 12:00:00"/>
      <el-step title="订单已签收，期待再次为您服务" description="2022-04-01 12:00:00"/>
    </el-steps>
  </el-dialog>
